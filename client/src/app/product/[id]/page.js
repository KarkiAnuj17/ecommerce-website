...
/>
        ...
        <h2 className="mb-4">Home / T-Shirt</h2>
          ...
          <h2 className="text-3xl font-bold mb-4 m-4">Shoes Reebok Zig <br/> Kinetica 3</h2>
          {productDetail.map((item,index)=>(
          <p className="text-2xl font-semibold mb-6 m-4">
          ${item.price}
          </p>
          ))}
          <div className=" flex mb-4 gap-2 m-4">
...
<p className="p-1 text-justify">Experience the ultimate in style and comfort with the Nike Reebok Zig. Combining modern aesthetics with innovative technology, these shoes are perfect for both everyday wear and intense workouts.</p>
        </div>
      </div>
    </div>
