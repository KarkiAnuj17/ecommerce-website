...
import { Badge, Avatar, Input, Button, Divider, DateInput } from "@nextui-org/react";
    ...
    <div className='flex justify-center items-center m-36'>
      <div className='items-center bg-gray-100 border border-gray-300 m-10 p-4 rounded-3xl'>
        <div className='flex gap-3'>
          <img src='/eazymall.png' width={110} height={30} alt='eazymall Logo' />
          <div className="max-w-md">
            <div className="space-y-1">
              <h1 className="font-serif font-bold text-5xl">EazyMall</h1>
            </div>
