...
const Website = () => {
  return (
    ...
    <div className="flex flex-col bg-orange-400"><CustomNavbar/>
      <div className="flex flex-col lg:flex-row p-8 bg-gray-50 bg-orange-400">
        <Image
        ...
        <div className="flex flex-col justify-center p-6 bg-white shadow-lg rounded-lg w-full max-w-lg">
          ...
          <label className="p-1 font-mono text-base text-gray-600">Full Name</label>
          <Input
            isRequired
            id="fullName"
            name="fullName"
            ...
            width="100%"
          />
          <label className="p-1 font-mono text-base text-gray-600">Email</label>
          <Input
            isRequired
            id="email"
            name="email"
            ...
            width="100%"
          />
          <label className="p-1 font-mono text-base text-gray-600">Message</label>
          <Textarea
            isRequired
            id="message"
            name="message"
  ...
  <Card className="p-4 m-4 w-60 h-45 border border-inherit break-words">
    ...
    <p className="m-1 font-medium">Location Address</p>
  </Card>
