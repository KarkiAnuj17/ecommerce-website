...
const orders = [
  { no: '01', id: '#12345', date: 'Nov 20th, 22', price: '$50.00', status: 'New order' },
  { no: '02', id: '#32456', date: 'Nov 19th, 22', price: '$60.00', status: 'On Delivery' },
  { no: '03', id: '#43567', date: 'Nov 19th, 22', price: '$45.00', status: 'Available' }
];
const Order = () => {
  return (
